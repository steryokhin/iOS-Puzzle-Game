...
- (void)invalidateLayoutIfNecessary {
    ...
    [self.collectionView performBatchUpdates:^{
        ...
        [self.collectionView moveItemAtIndexPath:newIndexPath toIndexPath:previousIndexPath];
...
- (void)handlePanGesture:(UIPanGestureRecognizer *)gestureRecognizer {
    switch (gestureRecognizer.state) {
        ...
        case UIGestureRecognizerStateChanged: {
            ...
            /// We move invalidateLayoutIfNecessary to UIGestureRecognizerStateEnded because we want to
            /// update collection only when user drop cell
